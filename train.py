...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type = str, default = './models_ioa', help = 'saving path that is a folder')
    ...
    parser.add_argument('--img_save_interval', type = int, default = 5, help = 'interval between image save')
    ...
    parser.add_argument('--val_batch_size', type = int, default = 256, help = 'validation size of the batches')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = "/home/skayasth/deepfillv2/deepfillv2-grayscale/", \
        help = 'the base training folder for inpainting network')
    parser.add_argument('--imgsize', type = int, default = 32, help = 'size of image')
    # mask parameters
